...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% Esta função calcula U para a linha (l) e coluna (c) correspondente da
%%%% Jacopbiana.
...
%%%% Se a função for utilizada no método convencional
    ...
    indice_linha_chaveavel = (indice_xvar)./2;                                                          % Transformação do índice do vetor de mismatches para o índice das linhas chaveáveis
end
